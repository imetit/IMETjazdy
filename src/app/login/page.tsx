    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 gradient-primary relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center px-16">
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 w-fit mb-8">
            <Image src="/imet-logo.png" alt="IMET" width={48} height={48} className="brightness-200" />
          </div>
          <h2 className="text-4xl font-bold text-white mb-4">IMET</h2>
          <h3 className="text-xl font-medium text-indigo-200 mb-6">Interný systém</h3>
          ...
          <div className="mt-12 flex gap-6">
            <div className="text-center">
              ...
              <p className="text-xs text-indigo-300 mt-1">Prístup</p>
            </div>
            <div className="w-px bg-white/20" />
            <div className="text-center">
              <p className="text-3xl font-bold text-white">100%</p>
              <p className="text-xs text-indigo-300 mt-1">Online</p>
            </div>
            <div className="w-px bg-white/20" />
            <div className="text-center">
              <p className="text-3xl font-bold text-white">SSL</p>
              <p className="text-xs text-indigo-300 mt-1">Zabezpečené</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center px-6 bg-page-bg">
        <div className="w-full max-w-sm animate-fade-in">
          <div className="lg:hidden flex flex-col items-center mb-8">
            <div className="gradient-primary rounded-2xl p-3 mb-4 shadow-lg shadow-indigo-500/20">
              <Image src="/imet-logo.png" alt="IMET" width={40} height={40} className="brightness-200" />
            </div>
          </div>
