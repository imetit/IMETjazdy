      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            ...
            <input name="obstaravacia_cena" type="number" step="0.01" min="0" defaultValue={vozidlo?.obstaravacia_cena || ''} className="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm" />
          </div>
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">Koniec leasingu</label>
            <input name="leasing_koniec" type="date" defaultValue={vozidlo?.leasing_koniec || ''} className="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm" />
          </div>
        </div>
